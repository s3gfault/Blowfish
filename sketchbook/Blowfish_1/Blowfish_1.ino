...
#define CHRBUFSIZE 24
      ...
      else if(!(cmd.substring(1).compareTo("chd")) || !(cmd.substring(1).compareTo("CHD"))){
        mot_alt_cont_auto = 0;
      }
      else if(!(cmd.substring(1).compareTo("cre")) || !(cmd.substring(1).compareTo("CRE"))){
        mot_rl_cont_auto = 1;
      }
