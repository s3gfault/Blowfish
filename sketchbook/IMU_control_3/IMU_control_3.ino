...
SRF02 ultrasonic(0xE0,SRF02_CENTIMETERS);
//prototypes
...
#define MOT_R_IN1_PIN 7
#define MOT_R_IN2_PIN 1

#define MOT_L_IN1_PIN 11
#define MOT_L_IN2_PIN 12

#define MOT_ALT_IN1_PIN 5
#define MOT_ALT_IN2_PIN 4
...
#define GYRO_INT_THRES_Z 0.4f
  ...
  if(motcont){
    ...
    setMotDirection(deg2rad(dbg1f),64);
    dbg2f = pid_alt.step(100,ults_h);
    setMotAlt((int)dbg2f);
...
#define MOT_R_THRES 10
#define MOT_L_THRES 10
