...
#define PID_MOT_RL_KP 0.4f
#define PID_MOT_RL_KI 0.2f
#define PID_MOT_RL_KD 0.1f
...
#define PID_MOT_ALT_KP PID_KP
#define PID_MOT_ALT_KI PID_KD
#define PID_MOT_ALT_KD PID_KI
...
#define MOT_R_PWM_PIN 9
#define MOT_L_PWM_PIN 10
#define MOT_ALT_PWM_PIN 6

#define MOT_R_IN1_PIN 8
#define MOT_R_IN2_PIN 7

#define MOT_L_IN1_PIN 11
#define MOT_L_IN2_PIN 10

#define MOT_ALT_IN1_PIN 4
#define MOT_ALT_IN2_PIN 5
...
dbg1f = pid_rl.step(rl_ang,gf.z);
setMotDirection(dbg1f,100);
...
void setMotDirection(float angl,int sp0){
  ...
  sp0 = constrain(sp0,-127,127);
  int spr = constrain( ((int)(127*sin(constrain(angl,-90,90)) ) + sp0 ), -255,255 );
  int spl = constrain(((int)(127*-sin(constrain(angl,-90,90))) + sp0 ),-255,255);

  dbg1 = spr;
  dbg2 = spl;

  setMotSpeed(spr,MOT_R_IN1_PIN,MOT_R_IN2_PIN,MOT_R_PWM_PIN);
  setMotSpeed(spr,MOT_L_IN1_PIN,MOT_L_IN2_PIN,MOT_L_PWM_PIN);
